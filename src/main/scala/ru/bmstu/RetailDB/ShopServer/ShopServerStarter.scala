...
object ShopServerStarter extends App {
  ...
  final val PATH_TO_RETAIL_CACHE = "E:\\Sorry\\Documents\\IdeaProjects\\RetailDB\\target\\RetailCache"
  final val PATH_TO_CARDS_CACHE = "E:\\Sorry\\Documents\\IdeaProjects\\RetailDB\\target\\RetailCache\\Cards"
  final val PATH_TO_SHOP_CACHE = "E:\\Sorry\\Documents\\IdeaProjects\\RetailDB\\target\\RetailCache\\Shop"
